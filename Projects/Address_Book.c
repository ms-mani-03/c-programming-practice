...
void contact_create(struct Address_book *book)
{
        ...
        if(book->contact_count < 100)
        {
                ...
                scanf(" %10[^\n]", book->book[book->contact_count].phone);
                if(!valid_number(book))
                {
                ...
                {
                        if(strcmp(book->book[i].phone, book->book[book->contact_count].phone) == 0)
                        {
                ...
                for(i = 0; i < book->contact_count; i++)
                {
                        if(strcmp(book->book[i].email, book->book[book->contact_count].email) == 0)
                        {
...
void search_name(struct Address_book *book)
{
        ...
        for(i = 0; i < book->contact_count; i++)
        {
                if(strstr(book->book[i].name, sch_name) != NULL)
                {
                        printf("%-5d ", i);
...
int edt_search_name(struct Address_book *book, char *sch_edt_name, int *found_index)
{
        ...
        for(i = 0; i < book->contact_count; i++)
        {
                if(strstr(book->book[i].name, sch_edt_name) != NULL)
                {
